"""LLM sentiment scoring of Netanyahu-related headlines.

Backends:
  - "api": Anthropic API (requires ANTHROPIC_API_KEY). Used in GitHub Actions,
    where the workflow maps the dedicated ANTHROPIC_API_KEY_BIBI secret into it.
...
VALID_CATEGORIES = {
    "criticism", "support", "legal", "family",
    "coalition_politics", "security_war", "neutral_report", "opinion", "other",
}
