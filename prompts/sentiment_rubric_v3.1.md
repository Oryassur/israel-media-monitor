...
v3.1: Israeli tech/business coverage is related and favorable; uncertainty
resolves to 0.)
...
obituaries of prominent Israelis, Israeli companies and technology (tech is
Israel's signature industry — business coverage of it shapes perception),
culture/lifestyle pieces set in Israel. Mark false only for incidental
matches: an individual's background mentioned in passing, sports trivia,
metaphorical uses ("holding X hostage").
...
- Israeli achievement — scientific, technological, economic (funding rounds,
  exits, innovations), cultural — → **+1** (non-conflict positive
...
- "Israeli startup raises $200M for AI chips" → related: true, +1, other (Israeli tech success — business coverage of Israel's signature industry)

When genuinely uncertain about the score, choose 0.
